...
export FRONTEND_PORT OPS_FRONTEND_PORT MINIO_PROXY_PORT LOCAL_DB_PORT
...
for engine in $E2E_ENGINES; do
  ...
  reset_stack
  BASE_URL="http://127.0.0.1:${FRONTEND_PORT}" OPS_BASE_URL="http://127.0.0.1:${OPS_FRONTEND_PORT}" E2E_DATABASE_URL="$HOST_DATABASE_URL" \
