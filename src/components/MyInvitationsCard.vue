...
.inv-badge { font-size: 11px; padding: 1px 7px; border-radius: var(--radius-md); background: var(--color-accent); color: var(--color-on-accent); }
.inv-alert { margin: 0; padding: 7px 11px; border-radius: var(--radius-sm); font-size: 13px; }
...
.inv-list li { display: flex; justify-content: space-between; align-items: center; gap: 10px; flex-wrap: wrap; padding: 8px 10px; border: 1px solid var(--color-border); border-radius: var(--radius-md); }
.inv-main { display: flex; align-items: center; gap: 8px; font-size: 13px; }
.inv-tag { font-size: 11px; padding: 1px 6px; border-radius: var(--radius-xs); background: var(--color-surface-strong); }
