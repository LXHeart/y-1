...
<style scoped>
.sfp { display: flex; flex-direction: column; gap: var(--space-xs); padding: var(--space-sm); border: 1px solid var(--color-border); border-radius: var(--radius-md); background: var(--color-surface); }
.sfp-head { display: flex; align-items: baseline; justify-content: space-between; gap: var(--space-xs); }
.sfp-head h4 { margin: 0; font-size: var(--type-caption); }
.sfp-version { font-size: var(--type-caption); opacity: 0.55; }
.sfp-head-actions { display: flex; align-items: center; gap: var(--space-xs); }
.sfp-overlays { margin: 0; font-size: var(--type-caption); color: var(--color-text-secondary); }
.sfp-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: var(--space-xs); }
.sfp-list li { display: flex; flex-direction: column; gap: var(--space-micro); padding: var(--space-xs) var(--space-xs); border-radius: var(--radius-sm); background: var(--color-surface-strong, var(--color-surface)); }
.sfp-row { display: flex; align-items: center; gap: var(--space-xs); flex-wrap: wrap; }
.sfp-chip { font-size: var(--type-caption); padding: var(--space-micro) var(--space-xs); border-radius: var(--radius-lg); white-space: nowrap; }
...
.sfp-chip-low { background: color-mix(in srgb, var(--color-accent) 16%, transparent); color: var(--color-accent-2); }
.sfp-match { font-size: var(--type-caption); word-break: break-all; }
.sfp-deep { font-size: var(--type-caption); opacity: 0.6; border: 1px solid currentColor; border-radius: var(--radius-xs); padding: 0 var(--space-xxs); }
.sfp-item-actions { display: inline-flex; gap: var(--space-xs); margin-left: auto; }
.sfp-advice { margin: 0; font-size: var(--type-caption); opacity: 0.75; }
.sfp-clean { margin: 0; font-size: var(--type-caption); color: var(--color-success); }
.sfp-foot { display: flex; align-items: center; justify-content: space-between; gap: var(--space-xs); flex-wrap: wrap; }
.sfp-hint { font-size: var(--type-caption); opacity: 1; }
.sfp-error { margin: 0; padding: var(--space-xs) var(--space-sm); border-radius: var(--radius-sm); font-size: var(--type-caption); background: color-mix(in srgb, var(--color-danger) 14%, transparent); color: var(--color-danger); }
button { padding: var(--space-xxs) var(--space-sm); font-size: var(--type-caption); border: 1px solid var(--color-border); border-radius: var(--radius-sm); background: transparent; color: var(--color-text); cursor: pointer; }
