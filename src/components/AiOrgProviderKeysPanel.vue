...
.error-state { color: var(--color-danger); }.error-state.compact { padding: var(--space-xxs) 0 0; text-align: left; }
.endpoint-hint { margin: 0; color: var(--color-text-muted); font-size: var(--type-caption); line-height: 1.5; }
...
.policy-band { display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: var(--space-xxs) var(--space-md); align-items: center; padding: var(--space-sm) var(--space-md); border: 1px solid var(--color-border); border-radius: var(--radius-md); }
.policy-band strong { color: var(--color-text); font-size: var(--type-body-sm); }
.policy-band p { margin: var(--space-xxs) 0 0; color: var(--color-text-muted); font-size: var(--type-caption); }
.policy-toggle { display: flex; align-items: center; gap: var(--space-xs); font-size: var(--type-body-sm); color: var(--color-text-secondary); white-space: nowrap; }
...
@media (max-width: 700px) { .panel-heading, .key-row { align-items: flex-start; flex-direction: column; }.row-actions { width: 100%; }.row-actions button { flex: 1; } .policy-band { grid-template-columns: minmax(0, 1fr); } form { grid-template-columns: minmax(0, 1fr); } form > * { grid-column: 1; } }
</style>
