...
<style scoped>
.sub { display: flex; flex-direction: column; gap: var(--space-xs); padding-top: var(--space-xs); border-top: 1px dashed var(--color-border); }
.sub-alert { margin: 0; padding: var(--space-xs) var(--space-sm); border-radius: var(--radius-sm); font-size: var(--type-caption); }
...
.sub-hint { margin: 0; font-size: var(--type-caption); opacity: 1; }
.sub-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: var(--space-xs); }
.sub-list > li { display: flex; flex-direction: column; gap: var(--space-xxs); padding: var(--space-xs) var(--space-sm); border: 1px solid var(--color-border); border-radius: var(--radius-md); }
.sub-main { display: flex; align-items: center; gap: var(--space-xs); flex-wrap: wrap; font-size: var(--type-caption); }
.sub-main a { color: var(--color-accent-2); word-break: break-all; }
.sub-meta { margin: 0; font-size: var(--type-caption); opacity: 1; }
.sub-reject { color: var(--color-danger); opacity: 0.9; }
.sub-tag { font-size: var(--type-caption); padding: var(--space-micro) var(--space-xs); border-radius: var(--radius-xs); background: var(--color-surface-strong); }
...
.sub-flagged { background: color-mix(in srgb, var(--color-danger) 22%, transparent); color: var(--color-danger); margin-left: var(--space-xs); }
...
.sub-checks { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: var(--space-xxs); }
.sub-checks li { display: flex; align-items: center; gap: var(--space-xs); flex-wrap: wrap; font-size: var(--type-caption); }
.sub-check-detail { opacity: 0.65; word-break: break-all; }
.sub-row { display: flex; align-items: center; gap: var(--space-xs); flex-wrap: wrap; }
.sub-form { display: flex; flex-direction: column; gap: var(--space-xs); }
.sub-atts { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: var(--space-xxs); }
.sub-atts li { display: flex; align-items: center; gap: var(--space-xs); font-size: var(--type-caption); padding: var(--space-xxs) var(--space-xs); border-radius: var(--radius-sm); background: var(--color-surface-strong); }
.sub-att-name { flex: 1 1 auto; word-break: break-all; }
.sub-att-size { opacity: 0.6; white-space: nowrap; }
.sub-atts button { padding: var(--space-micro) var(--space-sm); font-size: var(--type-caption); }
.sub-file { display: inline-flex; align-items: center; gap: var(--space-xs); font-size: var(--type-caption); cursor: pointer; }
.sub-file input[type="file"] { display: none; }
.sub-file span { padding: var(--space-xs) var(--space-md); border: 1px dashed var(--color-border); border-radius: var(--radius-sm); }
.sub-file input:disabled + span { opacity: 0.5; cursor: not-allowed; }
input { flex: 1 1 220px; padding: var(--space-xs) var(--space-sm); border: 1px solid var(--color-border-control); background: var(--color-surface); color: var(--color-text); border-radius: var(--radius-sm); font-size: var(--type-caption); }
