...
.wal-head h3 { margin: 0; font-size: var(--type-body); }
.wal h4 { margin: var(--space-sm) 0 0; font-size: var(--type-body-sm); }
...
.wal-groups dt { color: var(--color-text-muted); font-size: var(--type-caption); }
.wal-groups dd { margin: var(--space-xs) 0 0; font-size: var(--type-body); font-variant-numeric: tabular-nums; }
...
.wal-table { width: 100%; border-collapse: collapse; font-size: var(--type-body-sm); }
...
.wal-fee { font-size: var(--type-caption); color: var(--color-text-muted); margin-left: var(--space-sm); }
.wal-hint { margin: 0; font-size: var(--type-caption); color: var(--color-text-muted); }
...
.wal-quiet { font-size: var(--type-caption); padding: var(--space-xs) var(--space-md); }
