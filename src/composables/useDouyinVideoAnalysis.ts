import { ref } from 'vue'
import type { ApiResponse, DouyinVideoAnalysisResult } from '../types/douyin'
...
export function useDouyinVideoAnalysis() {
  ...
  async function analyzeVideo(proxyVideoUrl: string): Promise<DouyinVideoAnalysisResult | null> {
