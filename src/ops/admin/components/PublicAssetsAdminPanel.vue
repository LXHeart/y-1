<template>
  <div class="public-assets-panel">
    ...
    <section aria-labelledby="public-review-title">
      <div class="panel-toolbar"><div><h3 id="public-review-title">待审公共素材</h3><p>通过后进入公共素材库，驳回必须填写原因。</p></div><form class="review-search" @submit.prevent="submitPublicAssetSearch"><input v-model="publicAssetSearch" type="search" maxlength="100" aria-label="搜索公共素材" placeholder="搜索标题或标签"><button class="refresh-btn" type="submit" :disabled="publicAssetsLoading">搜索</button></form></div>
...
<style scoped>
.panel-toolbar { display: flex; align-items: flex-end; justify-content: space-between; gap: var(--space-md); }
.panel-toolbar h3, .panel-toolbar p { margin: 0; }
.panel-toolbar h3 { font-size: var(--type-body); }
.review-search{display:flex;align-items:center;gap:var(--space-xs)}.review-search input{min-width:min(280px,56vw);min-height:var(--control-height);padding:var(--space-xs) var(--space-xs);border:1px solid var(--color-border-control);border-radius:var(--radius-sm);background:var(--color-surface);color:var(--color-text)}
.panel-toolbar p { margin-top: var(--space-xxs); color: var(--color-text-muted); font-size: var(--type-caption); }
.refresh-btn, .approve-btn, .reject-btn { min-height: var(--control-height); padding: 0 var(--space-sm); border-radius: var(--radius-sm); font-size: var(--type-caption); cursor: pointer; }
...
.review-actions { display: flex; gap: var(--space-xs); }
.type-tag { display: inline-block; padding: var(--space-xxs) var(--space-xs); border: 1px solid var(--color-border); border-radius: var(--radius-pill); background: var(--surface-muted); white-space: nowrap; }
...
.public-assets-panel,.public-assets-panel > section,.public-generation{display:grid;gap:var(--space-md)}.public-assets-panel > section + section{padding-top:var(--space-lg);border-top:1px solid var(--color-border)}.public-generation-form{display:grid;grid-template-columns:repeat(5,minmax(120px,1fr)) auto;align-items:end;gap:var(--space-sm)}.public-generation-form label,.public-asset-body label{display:grid;gap:var(--space-xxs);color:var(--color-text-muted);font-size:var(--type-caption)}.public-generation-form input,.public-generation-form select,.public-asset-body input{width:100%;min-height:var(--control-height);padding:var(--space-xs) var(--space-xs);border:1px solid var(--color-border-control);border-radius:var(--radius-sm);background:var(--color-surface);color:var(--color-text);box-sizing:border-box}.generation-submit{min-height:36px;white-space:nowrap}.generation-results{display:grid;gap:var(--space-xs);padding:var(--space-sm) 0}.generation-results ol{display:grid;gap:var(--space-xs);margin:0;padding-left:var(--space-lg)}.generation-results li{overflow-wrap:anywhere}.generation-results li span:first-child{display:inline-block;min-width:62px}.generation-ok a{color:var(--color-accent-2)}.generation-failed{color:var(--color-danger)}.public-review-scroll{max-height:min(560px,72vh);overflow:auto}.public-review-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:var(--space-sm)}.public-review-item{display:grid;grid-template-columns:112px minmax(0,1fr);min-height:164px;border:1px solid var(--color-border);border-radius:var(--radius-md);background:var(--color-surface);overflow:hidden}.public-asset-preview{display:grid;place-items:center;min-height:164px;background:var(--surface-muted);color:var(--color-text-muted);font-size:var(--type-caption)}.public-asset-preview img{width:100%;height:100%;object-fit:cover}.public-asset-body{display:grid;align-content:start;gap:var(--space-xs);min-width:0;padding:var(--space-sm)}.public-asset-heading{display:flex;align-items:start;justify-content:space-between;gap:var(--space-xs)}.public-asset-heading h4,.public-asset-body p{margin:0}.public-asset-heading h4{min-width:0;font-size:var(--type-body-sm);overflow-wrap:anywhere}.public-asset-body p{color:var(--color-text-muted);font-size:var(--type-caption)}.approve-btn:disabled,.reject-btn:disabled{opacity:.5;cursor:not-allowed}@media(max-width:640px){.public-generation-form{grid-template-columns:minmax(0, 1fr)}.public-review-item{grid-template-columns:88px minmax(0,1fr)}}@media(min-width:641px) and (max-width:1100px){.public-generation-form{grid-template-columns:repeat(2,minmax(180px,1fr))}}
</style>
