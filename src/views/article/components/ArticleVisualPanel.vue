...
.item-title { font-size: var(--type-body); font-weight: var(--weight-heading); }
.purpose { color: var(--color-text-secondary); font-size: var(--type-body); }
.bound-block { color: var(--color-text-muted); font-size: var(--type-body); }
