...
class AdjudicationPropertiesTest {
    ...
    void fallsBackToHoursWhenNoSecondsOverride() {
        var props = new AdjudicationProperties(7, 24, 2, 48, 1, 168, 60, 0, 0);
    ...
    void secondsOverrideTakesPrecedence() {
        var props = new AdjudicationProperties(7, 24, 2, 48, 1, 168, 60, 60, 90);
    ...
    void overridesAreIndependent() {
        var props = new AdjudicationProperties(7, 24, 2, 48, 1, 168, 60, 30, 0);
    ...
    void negativeOverrideIsTreatedAsUnset() {
        var props = new AdjudicationProperties(7, 24, 2, 48, 1, 168, 60, -5, -1);
    ...
    void invalidHoursStillFallBackToDefaults() {
        var props = new AdjudicationProperties(0, 0, 0, 0, 0, 0, 0, 0, 0);
