 ...
 */
public final class DouyinFilename {

    static final String DEFAULT_DOWNLOAD_FILENAME = "douyin-video.mp4";
    ...
    private static String truncateFilenameBase(String base) {
        ...
        return trimmed.isEmpty() ? "douyin-video" : trimmed;
    }
}
