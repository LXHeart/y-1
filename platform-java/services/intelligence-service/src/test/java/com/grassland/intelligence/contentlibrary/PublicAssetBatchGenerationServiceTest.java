...
class PublicAssetBatchGenerationServiceTest {
	...
	@Mock
	private ImageGenerationClient images;
	@Mock
	private FrozenImageGenerationConfigResolver frozenConfig;
	@Mock
	private ImageGenerationConfig runtimeConfig;
	@Mock
	private AiExecutionService executions;
	@Mock
	private ObjectProvider<ObjectStorageAdapter> storageProvider;
	@Mock
	private ObjectStorageAdapter storage;
	@Mock
	private MediaReferenceRepository media;
	@Mock
	...
	void batchIsSequentialPartiallySuccessfulAndPersistsPermanentPendingAssets() {
		...
		var result = service.generate("reviewer", new PublicAssetBatchGenerationService.Command(
				PublicAssetBatchGenerationService.Kind.BACKGROUND, "夏日", "清爽", 3, Instant.now().plusSeconds(86400)))
				.block();
