...
public final class IdentityAuthorizationManifest {
	...
	private static Map<String, ControllerPolicy> build() {
		...
		policies.put(ROOT + "permission.PermissionRequestController",
				new ControllerPolicy(ORGANIZATION_SCOPED, Map.of("listQueue", ADMIN, "attachmentDownload", ADMIN, "get",
						ADMIN, "claim", ADMIN, "audit", ADMIN, "review", ADMIN)));
