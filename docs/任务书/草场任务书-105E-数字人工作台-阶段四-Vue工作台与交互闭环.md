...
下面是阶段全局上限；每卡仍只可改其§11表内文件，取两者交集。NEW仅首创，MODIFY_AFTER表明前卡已创建，不得重建覆盖。只读锚点不是写权限。测试产物可写test-artifacts/task-105/E及卡内指定`test-artifacts/task-105/`子目录（Git忽略），不能放根目录或提交用户内容。
...
需求：DH-R01、DH-R02、DH-R19、DH-R20。依赖：C105D-06。必读共享：K02、K03、K11、K13；本卡接口/字段不另定义替代名。
...
需求：DH-R03、DH-R04、DH-R05、DH-R06、DH-R19。依赖：C105E-01。必读共享：K01、K02、K03、K11、K13；本卡接口/字段不另定义替代名。
...
4. 开始dialog明确text来源、平台转写/配音、render补贴、取消规则、限时、默认不保存；点击确认才create，preflight失效回到确认不自动改价继续。
...
需求：DH-R07、DH-R09、DH-R10、DH-R11、DH-R15。依赖：C105E-02。必读共享：K04、K06、K07、K11、K13；本卡接口/字段不另定义替代名。
...
需求：DH-R07、DH-R08、DH-R10、DH-R19。依赖：C105E-03。必读共享：K01、K07、K11、K13；本卡接口/字段不另定义替代名。
...
需求：DH-R11、DH-R12、DH-R15、DH-R19。依赖：C105E-04。必读共享：K03、K06、K09、K11、K13；本卡接口/字段不另定义替代名。
...
需求：DH-R01、DH-R02、DH-R07、DH-R08、DH-R09、DH-R10、DH-R11、DH-R12、DH-R19。依赖：C105E-05。必读共享：K07、K11、K12、K13；本卡接口/字段不另定义替代名。
