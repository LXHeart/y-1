...
> 任务书版本：1.0 ｜ 编写日期：2026-09-15 ｜ 采用模板：2.4.1
> 规格作者、实施统筹与集成验收负责人：当前主程 Codex；后续执行者承接同一职责。
> 仓库：`/Users/LXH/claude/y-1` ｜ 核验分支：`main` ｜ 代码基线：`2f27a40b885bc092c2034c223b22f181087d1f34`。
> 文档状态：READY_FOR_IMPLEMENTATION ｜ 实施状态：NOT_STARTED ｜ 执行模式：用户启动实施后 AUTO_CHAIN。
> 本次交付是开发任务书。全部任务卡、迁移、测试和验收脚本均为待实施内容，不能据此认定问题已修复。
...
| R03 P1 | `IntelligenceComplianceRepository.activeJobCount/erasePii`、`ComplianceService.eraseAccount` | 旧草稿已删而原稿/画布/有效凭据仍在；queued 同步未计阻塞 | 资源/任务全部接入；未清完不能完成 |
...
| 类型 | 精确文件 |
|---|---|
| EXISTING | [platform-java/services/intelligence-service/src/main/java/com/grassland/intelligence/compliance/IntelligenceComplianceRepository.java](../../platform-java/services/intelligence-service/src/main/java/com/grassland/intelligence/compliance/IntelligenceComplianceRepository.java) |
...
| C103-08 | 完整活动任务清单与注销准备屏障 | C103-01 | `REQ103-03` | W08 | NOT_STARTED |
| C103-09 | 分阶段清理全部个人创作数据并核实完成回执 | C103-08 | `REQ103-03` | W08 W09 | NOT_STARTED |
| C103-10 | 对象删除、派生缓存、公众号凭据缓存与浏览器残留 | C103-09 | `REQ103-03` | W09 W10 | NOT_STARTED |
| C103-11 | 争议列表和详情的登录恢复、KeepAlive与读取代次 | C103-01 | `REQ103-04` | W11 | NOT_STARTED |
| C103-12 | 争议写目标捕获、未知结果核实与证据组件拆分 | C103-11 | `REQ103-04` | W11 W12 | NOT_STARTED |
| C103-13 | 完整履约事件通知与精确合作深链 | C103-03、C103-04、C103-11、C103-12 | `REQ103-05` | W13 | NOT_STARTED |
| C103-14 | 真实通知事务、重复投递、DLT与补发边界 | C103-13 | `REQ103-05` | W14 | NOT_STARTED |
| C103-15 | 经营事实查询、已结净额快照与金标准样本 | C103-06 | `REQ103-06` | W15 | NOT_STARTED |
| C103-16 | 看板、排行、导出和告警统一消费经营事实 | C103-15 | `REQ103-06` | W15 W16 | NOT_STARTED |
| C103-17 | 成员池全部写路径的组织级事务互斥 | C103-01 | `REQ103-08` | W17 | NOT_STARTED |
| C103-18 | 历史一致性只读诊断与可审阅重放计划 | C103-03、C103-06、C103-10、C103-14、C103-16、C103-17 | `REQ103-01`、`REQ103-02`、`REQ103-03`、`REQ103-05`、`REQ103-06`、`REQ103-08`、`REQ103-15` | W18 | NOT_STARTED |
| C103-19 | 持久化资源、后台任务和事件消费者接入门禁 | C103-08、C103-09、C103-10、C103-13、C103-14 | `REQ103-10` | W19 | NOT_STARTED |
| C103-20 | 受信端点白名单跨副本有界刷新 | C103-01 | `REQ103-11` | W20 | NOT_STARTED |
| C103-21 | 五个 Java 热点类按职责拆分并保持前端装配层 | C103-03、C103-05、C103-06、C103-09、C103-10、C103-13、C103-15、C103-16 | `REQ103-12` | W21 | NOT_STARTED |
| C103-22 | 测试资源治理与稳定执行证据 | C103-12、C103-14、C103-21 | `REQ103-13` | W22 | NOT_STARTED |
| C103-23 | release-migrator 故障、升级和最低覆盖率 | C103-08、C103-15、C103-21 | `REQ103-13`、`REQ103-14` | W23 | NOT_STARTED |
| C103-24 | 全模块与跨服务业务不变量真实栈验收 | C103-04、C103-07、C103-10、C103-12、C103-14、C103-16、C103-17、C103-19、C103-20、C103-21、C103-22、C103-23 | `REQ103-15` | W24 | NOT_STARTED |
| C103-25 | 三浏览器、双主题、移动端和真实切案验收 | C103-24 | `REQ103-15` | W24 W25 | NOT_STARTED |
| C103-26 | 升级、灰度前置与安全回退执行包 | C103-18、C103-23、C103-24、C103-25 | `REQ103-14`、`REQ103-15` | W26 | NOT_STARTED |
| C103-27 | 最终回归、证据归档与任务状态收口 | C103-26 | `REQ103-15` | W27 | NOT_STARTED |
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-09`；规则 `BR-17`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-01`；规则 `BR-01`、`BR-02`、`BR-05`、`BR-16`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-01`；规则 `BR-01`、`BR-02`、`BR-04`、`BR-18`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-01`；规则 `BR-05`、`BR-06`、`BR-20`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-02`；规则 `BR-02`、`BR-03`、`BR-04`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-02`；规则 `BR-02`、`BR-03`、`BR-04`、`BR-10`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-07`；规则 `BR-11`、`BR-20`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-03`；规则 `BR-13`、`BR-15`、`BR-16`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-03`；规则 `BR-13`、`BR-14`、`BR-15`、`BR-18`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-03`；规则 `BR-13`、`BR-14`、`BR-16`、`BR-20`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-04`；规则 `BR-06`、`BR-16`、`BR-20`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-05`；规则 `BR-07`、`BR-08`、`BR-16`、`BR-20`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-05`；规则 `BR-07`、`BR-08`、`BR-18`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-06`；规则 `BR-09`、`BR-10`、`BR-18`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-06`；规则 `BR-09`、`BR-10`、`BR-18`、`BR-20`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-08`；规则 `BR-12`、`BR-16`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-01`、`REQ103-02`、`REQ103-03`、`REQ103-05`、`REQ103-06`、`REQ103-08`、`REQ103-15`；规则 `BR-02`、`BR-13`、`BR-18`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-10`；规则 `BR-07`、`BR-13`、`BR-15`、`BR-19`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-11`；规则 `BR-16`、`BR-17`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-12`；规则 `BR-17`、`BR-20`。
...
2. 目标原类行数：TaskController≤1200、CommerceRepository≤800、CommerceService≤700、VisualPlanService≤800、WechatDraftSyncService≤650；新增类≤600。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-13`；规则 `BR-17`、`BR-19`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-13`、`REQ103-14`；规则 `BR-17`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-15`；规则 `BR-01`、`BR-03`、`BR-07`、`BR-09`、`BR-12`、`BR-13`、`BR-16`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-15`；规则 `BR-06`、`BR-20`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-14`、`REQ103-15`；规则 `BR-02`、`BR-13`、`BR-17`、`BR-18`。
...
**执行包**：v1.0；状态 NOT_STARTED；负责人/验收统筹为当前执行主程；需求 `REQ103-15`；规则 `BR-17`、`BR-18`、`BR-19`。
...
| 业务实施 | 尚未启动 | 所有卡NOT_STARTED，未来测试NOT_RUN；生产/真实供应商未调用 |
